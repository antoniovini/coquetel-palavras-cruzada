        ...
        <div className="tip-box">
          <Button
            ...
            onClick={() =>
              // setSelectedWord(() => {
              //   // if (selectedWord <= 1) {
              //   //   setSelectedWord(board.words[board.word.length].word);
              //   // } else {
          ...
          <h2>{`${selectedWord}. ` + initialBoard.tips.filter(tip => tip.word === selectedWord)[0].value}</h2>
          <Button
            flat
            type="button"
            onClick={() =>
              // setSelectedWord(() => {
              //   // if (board.words[board.word.length].word === selectedWord) {
              //   //   setSelectedWord(0);
              //   // } else {
              //   //   setSelectedWord(selectedWord + 1);
              //   // }
